  ...
  return (
    <View style={styles.screen}>
      <View style={styles.navbar}>
        ...
        <TouchableOpacity onPress={() => Alert.alert('Welcome', 'Welcome to the Goal List Application!')}>
      ...
      >
        <View style={styles.warningModal}>
          <Text style={styles.warningText}>Warning: You have more than 5 goals. Don't overwhelm yourself!</Text>
